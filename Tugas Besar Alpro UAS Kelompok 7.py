...
root.geometry("430x445")

myfont  = font.Font(size=15)

e = Entry(root, width=25, borderwidth=5, fg="black", bg="black")
e["font"]= myfont
e["bg"] = "#d1d1d1"
...
def deg():
    ...
    n_awal = int(nomor_awal)
    e.delete(0,END)
    e.insert(0, math.degrees(n_awal))

def sin():
    nomor_awal = e.get()
    global n_awal
    n_awal = int(nomor_awal)
    radian = math.radians(n_awal)
    e.delete(0,END)
    e.insert(0, math.sin(radian))
...
deg = Button(root,text="deg",padx = 30,bg="#878787",fg="white", pady = 20,command=deg)
sin = Button(root,text="sin",padx = 33,bg="#878787",fg="white", pady = 20,command=sin)
cos = Button(root,text="cos",padx = 32,bg="#878787",fg="white", pady = 20,command=cos)
tan = Button(root,text="tan",padx = 32,bg="#878787",fg="white", pady = 20,command=tan)
lg = Button(root,text="log",padx = 32,bg="#878787",fg="white", pady = 20,command=lg)
ln = Button(root,text="ln",padx = 32,bg="#878787",fg="white", pady = 20,command=ln)
